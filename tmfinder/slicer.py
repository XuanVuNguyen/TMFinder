...
class ProteinSlicer:
    ...
    def calc_hydrophobic_factor(
        cls, residues: List[Residue], residue_properties: ResiduePropertyMapper
    ):
        hydrophobic_sum = sum(
    ...
    def calc_Q_score(
        ...
        return (
            cls.calc_hydrophobic_factor(residues, residue_properties)
            * cls.calc_structure_factor(residues, residue_properties)
            / width
        )
    ...
    def slice(self, residue_properties):
        ...
        for res_id_group in sliced_res_ids:
            ...
            _sliced_q_scores.append(
                self.calc_Q_score(sliced_res, residue_properties, 1)
            )
